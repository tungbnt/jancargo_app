...
class PaymentedTab extends StatefulWidget {
  const PaymentedTab({super.key, required this.cubit});
  final AuctionManagerCubit cubit;

  @override
  State<PaymentedTab> createState() => _PaymentedTabState();
}

class _PaymentedTabState extends State<PaymentedTab> {
  bool isSearch = false;

  @override
  void initState() {
    super.initState();
    widget.cubit.getPaymentedTab();
  }
          ...
          SliverToBoxAdapter(
              child: InputField(
                onChange: (value) {
                  ...
                  widget.cubit.getPaymentedTab(keyword: value);
                },
