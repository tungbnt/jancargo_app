...
class LastHuntingTab extends StatefulWidget {
  const LastHuntingTab({super.key, required this.cubit});
  final AuctionManagerCubit cubit;

  @override
  State<LastHuntingTab> createState() => _LastHuntingTabState();
}

class _LastHuntingTabState extends State<LastHuntingTab> {
  bool isSearch = false;

  @override
  void initState() {
    super.initState();
    widget.cubit.getLastHunting();
  }
          ...
          SliverToBoxAdapter(
              child: InputField(
                onChange: (value) {
                  ...
                  widget.cubit.getLastHunting(keyword: value);
                },
