...
class WidgetTimerAuction extends StatefulWidget {
  const WidgetTimerAuction({super.key, required this.dateString});
  final String dateString;

  @override
  State<WidgetTimerAuction> createState() => _WidgetTimerAuctionState();
}

class _WidgetTimerAuctionState extends State<WidgetTimerAuction> {
  late Timer timer;
  ...
  void _timeConvert({required Duration duration}){
    targetDateTime = DateTime.parse(widget.dateString);
