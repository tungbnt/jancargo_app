...
class WidgetArrangeAuctionManager extends StatefulWidget {
  const WidgetArrangeAuctionManager({super.key, required this.filterModel, required this.contextFavorite});

  final FavoriteFilterModel filterModel;
  final BuildContext contextFavorite;

  @override
  State<WidgetArrangeAuctionManager> createState() =>
      _WidgetFilterFavorite();
}

class _WidgetFilterFavorite extends State<WidgetArrangeAuctionManager> {
  @override
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                AppGap.sbH10,
                FilterRadioHorizontal(title: 'Sắp xếp theo',cubit: widget.filterModel.searchCubit,filterModelForView: widget.filterModel.conditionsFilterController,),
              ],
            ),
          ),
        ),
