...
class SearchAmazonUsItems extends StatefulWidget {
  const SearchAmazonUsItems({super.key,required this.dto});

  final AmazonSearchKeyWordDto dto;

  @override
  State<SearchAmazonUsItems> createState() => _SearchAmazonUsItemsState();
}

class _SearchAmazonUsItemsState extends State<SearchAmazonUsItems> {
  @override
