...
class RakutenItem extends StatefulWidget {
  const RakutenItem({super.key, required this.itemsDto, required this.cart});

  final AllSearchItems itemsDto;
  final ValueNotifier<bool> cart;

  @override
  State<RakutenItem> createState() => _RakutenItemState();
}

class _RakutenItemState extends State<RakutenItem> {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  AppConvert.convertAmountVn(widget.itemsDto.price!),
                  style: AppStyles.text7016(color: AppColors.primary700Color),
                ),
                Text(
                  AppConvert.convertAmountJp(widget.itemsDto.price!),
